#!/usr/bin/env python3
"""
Paper 1, Supplementary Figure S10: Coding Detection in Context
...
S10_DIR = Path("results/paper1/supplementary")
...
def main():
    ...
    plt.savefig(S10_DIR / "s10_coding_context.png", dpi=200, bbox_inches="tight", facecolor="white")
    plt.savefig(S10_DIR / "s10_coding_context.pdf", bbox_inches="tight", facecolor="white")
    plt.close()
    print(f"Saved to {S10_DIR}/s10_coding_context.png and .pdf")
